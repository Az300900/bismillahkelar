...
%  LANEFOLLOWINGEKFSTATEFCN State function used by the Extended Kalman Filter block.
% 
% Inputs: xk: Current state values u: Current input values Outputs: xk1: Updated 
% state values based on xk and uk
uk = [u(1) u(2) u(3) u(4)];
Ts = u(5);
